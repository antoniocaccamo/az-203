    ...
    internal class Program
    {
        ...
        private async Task ProcessAsync()
        {
            ...
            using (BatchClient batchClient = BatchClient.Open(sharedKeyCredentials))
            {
                ...
                List<CloudTask> tasks = await AddTasksAsync(batchClient, JobId, inputFiles, outputContainerSasUrl);
        ...
        private async Task CreatePoolIfNotExistAsync(BatchClient batchClient, string poolId)
        {
            CloudPool pool = null;
            try
            {
        ...
        private async Task<List<CloudTask>> AddTasksAsync(BatchClient batchClient, string jobId, List<ResourceFile> inputFiles, string outputContainerSasUrl)
        {
        ...
        private async Task<ResourceFile> UploadResourceFileToContainerAsync(CloudBlobClient blobClient, string containerName, string filePath)
        {
